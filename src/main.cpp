...
#define LEAD_MM_600 4
#define LEAD_MM_250 8
...
mtr::Motor x_axis(X_SPI_SEL, X_LIM, FOLGER_TECH_STEPS_PER_REV, LEAD_MM_600, FOLGER_TECH_ACCEL, FOLGER_TECH_SPEED, FOLGER_TECH_MILLIAMPS, FOLGER_TECH_MICRO_RES);
mtr::Motor y_axis(Y_SPI_SEL, Y_LIM, FOLGER_TECH_STEPS_PER_REV, LEAD_MM_600, FOLGER_TECH_ACCEL, FOLGER_TECH_SPEED, FOLGER_TECH_MILLIAMPS, FOLGER_TECH_MICRO_RES);
mtr::Motor z_axis(Z_SPI_SEL, Z_LIM, FOLGER_TECH_STEPS_PER_REV, LEAD_MM_250, FOLGER_TECH_ACCEL, FOLGER_TECH_SPEED, FOLGER_TECH_MILLIAMPS, FOLGER_TECH_MICRO_RES);
